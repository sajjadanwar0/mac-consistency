---- MODULE MC_A1_TTrace_1778167176 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("MC_A1_TTrace_1778167176.json", _TETrace)
...
\*
\*trace == IODeserialize("MC_A1_TTrace_1778167176.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG MC_A1_TTrace_1778167176 ----
CONSTANTS
    Agents = { a1 , a2 }
    Cells = { c1 }
    Values = { v1 , v2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Thu May 07 20:19:37 PKT 2026